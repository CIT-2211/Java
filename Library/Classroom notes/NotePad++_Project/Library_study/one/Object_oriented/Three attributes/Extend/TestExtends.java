...
public class TestExtends{
	...
	public static void main (String[] args){
		Student s1 = new Student("罗洋",(byte)21,180,130,"计算机与科学");
...
class Person{
	...
	public Person(String name,byte age,int height,int weight){
		this.name = name;
		this.age = age;
		this.height = height;
		this.weight = weight;
...
class Student extends Person{
		...
		public Student(String name,byte age,int height,int weight,String major){
			super(name,age,height,weight);
			this.major = major;
			this.action_major = false;
			count_Student++;
			System.out.println("加入了学生"+gitName());
		}
		...
		System.out.println("学生"+gitName()+"已经开始行动！");	
		System.out.println(gitName() + "正在" + major + "实验室做实验");
		}else{
		System.out.println("学生"+gitName()+"正在上课！");
			}
		}
	}
