...
public class PixelTankGame extends JFrame {
    ...
    private static final int PLAYER_SPEED = 5; // 提高玩家速度
    ...
    private void spawnEnemy() {
        ...
        int x, y;
        do {
            x = (int) (Math.random() * (WIDTH - TILE_SIZE));
            y = (int) (Math.random() * (HEIGHT - TILE_SIZE));
        } while (isInSpawnZone(x, y));
        
        gameState.enemies.add(new EnemyTank(x, y, difficulty, difficultyLevel));
    }
    
    private boolean isInSpawnZone(int x, int y) {
        // 玩家1出生区域
        Rectangle p1Zone = new Rectangle(80, 80, TILE_SIZE * 3, TILE_SIZE * 3);
        // 玩家2出生区域
        Rectangle p2Zone = new Rectangle(WIDTH - 150, HEIGHT - 150, TILE_SIZE * 3, TILE_SIZE * 3);
        
        return p1Zone.contains(x, y) || p2Zone.contains(x, y);
    }
    ...
    private class MoveAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (player != null) {
                player.move(dx, dy, gameState.walls, gameState.getAllTanks());
    ...
    static class GameState {
        ...
        private void clearSpawnZones() {
            ...
            while (wallIter.hasNext()) {
                ...
                Rectangle wallRect = new Rectangle(wall.x, wall.y, TILE_SIZE, TILE_SIZE);
                if (p1Zone.intersects(wallRect) || p2Zone.intersects(wallRect)) {
                    wallIter.remove();
                }
            }
        }
        ...
        private void generateMap() {
            ...
            for (int i = 0; i < 50; i++) {
                ...
                Rectangle p1Zone = new Rectangle(80, 80, TILE_SIZE * 3, TILE_SIZE * 3);
                Rectangle p2Zone = new Rectangle(WIDTH - 150, HEIGHT - 150, TILE_SIZE * 3, TILE_SIZE * 3);
                Rectangle wallRect = new Rectangle(x, y, TILE_SIZE, TILE_SIZE);
        ...
        public List<Tank> getAllTanks() {
            ...
            allTanks.add(player1);
            if (player2 != null) allTanks.add(player2);
        ...
        public void update() {
            ...
            while (enemyIter.hasNext()) {
                ...
                enemy.update(player1, walls, getAllTanks());
        ...
        private void applyPowerUp(PlayerTank player, PowerUp.Type type) {
            switch (type) {
                case HEALTH:
                    ...
                    break;
                case SPEED:
                    player.speed = Math.min(7, player.speed + 1.0); // 提高速度加成
                    break;
                case FIRE_RATE:
                    player.fireRate = Math.max(5, player.fireRate - 5); // 提高射速加成
                    break;
                case SCORE_BONUS:
                    player.score += 200;
                    break;
    ...
    static class GamePanel extends JPanel {
        ...
        private void drawUI(Graphics g) {
            ...
            // 显示速度
            g.drawString("Speed: " + String.format("%.1f", gameState.player1.speed), 20, 90);
        }
    }
    ...
    static abstract class Tank {
        ...
        int damage = 1;
        Color color; 
        boolean isPlayer; // 添加队伍标识
        
        public Tank(int x, int y, Color color, boolean isPlayer) {
            this.x = x;
            this.y = y;
        ...
        public void move(int dx, int dy, List<Wall> walls, List<Tank> otherTanks) {
            int newX = x + dx;
            int newY = y + dy;
    ...
    static class PlayerTank extends Tank {
        ...
        public void draw(Graphics g) {
            ...
            int[] xPoints = {x + width/2, x + width/4, x + width*3/4};
    ...
    static class EnemyTank extends Tank {
        ...
        public void update(PlayerTank player, List<Wall> walls, List<Tank> allTanks) {
            super.update();
            ...
            switch (direction) {
                case 0: move(0, (int) -speed, walls, allTanks); break;
                case 1: move((int) speed, 0, walls, allTanks); break;
                case 2: move(0, (int) speed, walls, allTanks); break;
                case 3: move((int) -speed, 0, walls, allTanks); break;
            }
        }
        ...
        public void draw(Graphics g) {
            ...
            int[] xPoints = {x + width/2, x + width/4, x + width*3/4};
            int[] yPoints = {y + height + 5, y + height - 5, y + height - 5};
            g.fillPolygon(xPoints, yPoints, 3);
        }
    }
    ...
    static class Bullet {
        ...
        public void draw(Graphics g) {
            ...
            if (owner instanceof PlayerTank) {
                g.setColor(Color.CYAN); // 玩家子弹为青色
            } else {
                g.setColor(Color.ORANGE); // 敌人子弹为橙色
            }
